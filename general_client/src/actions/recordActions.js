...
export const getRecords = () => dispatch => {
    ...
    axios.get('records', { baseURL: "https://csc398dev.utm.utoronto.ca:5001/nox/api/" })
        .then(res => dispatch({
            type: GET_RECORDS,
            payload: res.data
        }))
...
export const downloadSession = record => dispatch => {
    axios.download('records', { baseURL: "https://csc398dev.utm.utoronto.ca:5001/nox/api/" })
        .then(res => dispatch({
...
export const addRecord = (record) => dispatch => {
    axios
        .post('records', record, { baseURL: "https://csc398dev.utm.utoronto.ca:5001/nox/api/" })
        .then(res =>
            dispatch({
                type: ADD_RECORD,
                payload: res.data
